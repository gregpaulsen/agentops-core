...
echo "🔧 Starting Big Sky code patch..."
...
PATCH
    ...
    mv "$FILE.tmp" "$FILE"
    chmod +x "$FILE"
    echo "✅ Patched and made executable: $FILE"
  fi
done

echo "🧹 All relevant .command and .py files are now patched and future-proofed."
